...
extern const string pointCloudTopic = "/velodyne_points_HDL32";
extern const string imuTopic = "/imu/data";

// Save pcd
extern const string fileDirectory = "/home/wangzm/wzm_pcd";
...
//extern const int Horizon_SCAN = 1800;
//extern const float ang_res_x = 0.2; //600RPM -- 0.2du
